...
- 3 units
- MW 12:45-2:00p
- Physical: Engineering, Room 120
- Prerequisite: Admission to SICCS graduate program, STA 270, and ((MAT 136 and MAT 137) or MAT 131))
- Mode of Instruction: Face-to-face
- Instructor's Name: Joseph Mihaljevic
- Instructor's Contact Information: School of Informatics, Computing & Cyber Systems (SICCS) (Building 90) Room 213, (928) 523-5125, joseph.mihaljevic@nau.edu
- Instructor's Availability: Office hours: TBA
- Teaching Assistant: Amardeep Jetty, aj2569@nau.edu
- TA's Availability. Office hours: Tues, Thurs 2:30-3:30p; *Location TBA*
...
## INF511 Book Website
Dr. Mihaljevic has compiled a [course website](https://joseph-mihaljevic.github.io/inf511-book/) that is based on a GitHub repository. This website will have required readings, coded examples which we will walk through in class and problem set materials. The website will link to Bblearn for recorded lecture materials and for posted homework. There will be other required readings (see @sec-readings).
...
- Cheating, including plagiarism of writing or computer code, will not be tolerated. The University's Academic Integrity policies (@sec-univ-policy) will be strictly enforced. 
